        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Once processing is complete, click on any paper in your dashboard to see the full scorecard: TRL level, market validation score, risk factors, evidence quality, and regulatory pathway.
              </p>
              <Separator />
              <h3 className="font-medium">3. Create a research project</h3>
              <p className="text-sm text-muted-foreground">
                Go to <Badge variant="secondary">Projects</Badge> to create a new research initiative. Add papers to your project to see consolidated metrics: average TRL, average market validation, evidence distribution, and regulatory requirements.
              </p>
              <Separator />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <Separator />
              <div>
                <h3 className="font-medium">Market Validation (0–100)</h3>
                <p className="text-sm text-muted-foreground mt-1">
                  A calibrated signal built from <strong>real, verifiable data</strong>: FDA drug approvals (OpenFDA), clinical trial phases (ClinicalTrials.gov) and citation activity (Semantic Scholar). Weighted per domain. It is not a dollar projection — it measures how validated the surrounding field is.
                </p>
              </div>
              <Separator />
              <div>
          ...
          <CardContent>
            <Accordion type="single" collapsible>
              ...
              <AccordionItem value="q4">
                <AccordionTrigger>How is the market validation score calculated?</AccordionTrigger>
                <AccordionContent className="text-sm text-muted-foreground">
                  It is computed from real external data — not AI guesswork. The system extracts the paper&apos;s compounds, targets and diseases, then queries ClinicalTrials.gov (trial phases), OpenFDA (drug approvals in class) and Semantic Scholar (citation activity). Those signals are combined with domain-specific weights into a 0–100 score. The AI only synthesizes; it never invents the numbers.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
